...
public class PopCAD_v1 extends PApplet {
	...
	int gridSize = 3; // size of grid (assumes all dimensions are equal)
	int spacing = 80; // distance between points
		...
		while (myPort.available() > 0) {
			...
			if (inString != null) {
				...
				if (firstContact == false) {
					...
					//println("first contact = true");
					strokeWeight(8);
					// stroke(100);

					//inString = inString + "101010101010101010101010101"; //27 chars long
