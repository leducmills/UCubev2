...
//int capSwitches[] = {57,58,59,  32,30,28,  21,52,12,  50,48,46,  23,25,27, 5,6,7,  69,68,67, 37,39,41,  20,19,18};
//
//int toggleLeds[] = {54,55,56,  26,24,22,  8,9,10,  40,38,36,  29,31,33,  2,3,4, 66,65,64,  43,45,47, 17,16,15};
